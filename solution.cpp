...
public:
    ...
    Trip *bookTrip(std::string pick_up_location, std::string drop_location, std::string vehicle_number, int departure_time)
    {
        ...
        // to check if booktrip is working or not 
        // if(pick_up_location=="LocationX" && drop_location=="LocationZ" && vehicle_number=="XYZ" && departure_time==1500)
        // {
        //     return nullptr;
        // }
        ...
        // retrieve_trip->setBookedSeats(1);
